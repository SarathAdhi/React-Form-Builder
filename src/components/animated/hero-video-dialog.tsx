    ...
    <div className={cn("relative", className)}>
      ...
      >
        <Image
          ...
          width={1920}
          height={1080}
          className="mx-auto w-full max-w-4xl aspect-video object-cover object-top transition-all duration-200 group-hover:brightness-[0.8] ease-out rounded-md shadow-lg border"
        />
